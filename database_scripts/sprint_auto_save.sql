...
DROP FUNCTION IF EXISTS trigger_sprint_auto_save();
    ...
    LOOP
        ...
        IF r.current_week_total < 3000 THEN
            ...
            IF wallet_bal >= deficit THEN
                ...
                -- Credit Sprint via RPC (Pass the actual user_plan_id)
                PERFORM process_sprint_deposit(r.user_id, r.user_plan_id, deficit);
