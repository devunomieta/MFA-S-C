          ...
          <div className="grid md:grid-cols-2 gap-8 mb-16">
            <div className="p-8 bg-emerald-50 dark:bg-emerald-900/10 rounded-[2.5rem] border border-emerald-100 dark:border-emerald-800/50">
              ...
              <p className="text-slate-600 dark:text-slate-400 font-medium text-sm leading-relaxed">
                Mary's Thrift Services is a legally registered business entity in Nigeria under the
                Corporate Affairs Commission (CAC) with Registration Number{" "}
                <strong>BN-8950808</strong>.
              </p>
            </div>
            <div className="p-8 bg-blue-50 dark:bg-blue-900/10 rounded-[2.5rem] border border-blue-100 dark:border-blue-800/50">
              ...
              <p className="text-slate-600 dark:text-slate-400 font-medium text-sm leading-relaxed">
                We adhere to the highest standards of financial conduct for community savings,
                ensuring transparency in every contribution and payout turn.
              </p>
            </div>
          </div>
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none space-y-8">
            <section className="space-y-4">
              ...
              <p className="text-slate-600 dark:text-slate-400 leading-relaxed font-medium">
                We are committed to preventing our platform from being used for illicit activities.
                We implement Know Your Customer (KYC) procedures and monitor transactions for
                suspicious activity to maintain a safe environment for all savers.
              </p>
            </section>
            ...
            <section className="space-y-4">
              ...
              <p className="text-slate-600 dark:text-slate-400 leading-relaxed font-medium">
                Our platform structure ensures that payouts are handled with strict priority. Every
                member is verified before they can join high-value plans, protecting the collective
            ...
            <section className="space-y-4">
              ...
              <div className="p-6 bg-slate-50 dark:bg-slate-900/50 rounded-3xl border border-slate-100 dark:border-slate-800 flex items-start gap-4">
                ...
                <p className="text-sm text-slate-600 dark:text-slate-400 font-medium leading-relaxed">
                  We operate with 100% transparency. There are no hidden fees or undisclosed payout
                  delays. Our management team is accessible 24/7 to resolve any disputes or
                  questions regarding plan mechanics.
                </p>
              </div>
            </section>
          </div>
