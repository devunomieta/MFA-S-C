          ...
          <div className="prose prose-slate dark:prose-invert max-w-none space-y-8">
            <section className="space-y-4">
              ...
              <p className="text-slate-600 dark:text-slate-400 leading-relaxed font-medium">
                By accessing or using Mary's Thrift Services, you agree to be bound by these Terms
                of Service. If you do not agree to all of these terms, do not use our services.
              </p>
            </section>
            ...
            <section className="space-y-4">
              ...
              <p className="text-slate-600 dark:text-slate-400 leading-relaxed font-medium">
                To use our platform, you must be at least 18 years old and capable of forming a
                binding contract. You are responsible for ensuring that your use of the service
                complies with all applicable laws and regulations in Nigeria.
              </p>
            </section>

            <section className="space-y-4">
              <h2 className="text-2xl font-bold text-slate-900 dark:text-white">
                3. Saving Plans & Contributions
              </h2>
              <div className="grid md:grid-cols-2 gap-4">
                <div className="p-5 bg-slate-50 dark:bg-slate-900/50 rounded-2xl border border-slate-100 dark:border-slate-800">
                  ...
                  <p className="text-xs text-slate-600 dark:text-slate-400 font-medium">
                    Users must adhere to the contribution schedule of their chosen plan. Late
                    payments may result in penalties or delayed payouts.
                  </p>
                </div>
                <div className="p-5 bg-slate-50 dark:bg-slate-900/50 rounded-2xl border border-slate-100 dark:border-slate-800">
                  ...
                  <p className="text-xs text-slate-600 dark:text-slate-400 font-medium">
                    Payout turns are assigned based on the plan's structure. Withdrawals are
                    processed within 24-48 hours of reaching your turn.
                  </p>
                </div>
              </div>
            </section>
            ...
            <section className="space-y-4">
              ...
              <div className="p-6 bg-amber-50 dark:bg-amber-900/10 rounded-3xl border border-amber-100 dark:border-amber-900/30">
                ...
                <p className="text-sm text-amber-800 dark:text-amber-400 font-medium leading-relaxed">
                  Mary's Thrift Services is a community savings facilitator. We are not a bank or a
                  licensed financial institution. We provide the digital infrastructure to manage
                  traditional thrift (Ajo) contributions securely.
                </p>
              </div>
            </section>
