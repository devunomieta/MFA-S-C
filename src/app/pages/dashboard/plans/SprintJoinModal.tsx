...
export function SprintJoinModal({
  plan,
  isOpen,
  onClose,
  onSuccess,
    ...
    <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>Commit to a disciplined savings challenge.</DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-4 py-4">
          ...
          <div className="flex items-start gap-2">
            ...
            <Label htmlFor="agree" className="text-xs text-slate-600 leading-tight">
              I understand the rules. I authorize automatic deductions for missed weeks and
              understand withdrawals are locked for the duration.
            </Label>
          </div>
        </div>
