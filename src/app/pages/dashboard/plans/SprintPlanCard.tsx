          ...
          <div className="p-3 bg-gray-50 dark:bg-gray-800/50 rounded-lg border border-gray-100 dark:border-gray-800 space-y-2">
            <div className="flex justify-between text-xs font-bold text-gray-700 dark:text-gray-300">
              <span className="flex items-center gap-1.5 uppercase tracking-wider text-[10px] text-gray-500">
                <Timer className="w-3.5 h-3.5" /> This Week
              </span>
              <span
                className={currentWeekTotal >= weeklyTarget ? "text-emerald-600" : "text-amber-600"}
              >
      ...
      <CardHeader className="pb-4">
        <div className="flex justify-between items-start">
          <div>
            <Badge
              variant="secondary"
              className="mb-2 bg-blue-50 text-blue-700 border-blue-100 hover:bg-blue-100"
            >
              Saving Sprint
            </Badge>
      ...
      <CardContent className="flex-1 space-y-6 pt-2 overflow-y-auto max-h-[60vh] custom-scrollbar">
        ...
        <div className="space-y-4 pt-2">
          <div className="p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-100 dark:border-blue-800">
            <h4 className="text-[10px] font-bold text-blue-800 dark:text-blue-400 uppercase tracking-wider mb-2">
              Rules & Features
            </h4>
