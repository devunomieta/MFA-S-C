...
export function StepUpPlanCard({
  ...
  const weekProgress = isTargetMet
    ? 100
    : fixedAmount > 0
      ? Math.min((weekPaidSoFar / fixedAmount) * 100, 100)
      : 0;
      ...
      <Card className="flex flex-col relative overflow-hidden bg-white dark:bg-gray-900 border-l-4 border-l-purple-500 shadow-sm hover:shadow-md transition-shadow">
          ...
          {isCompleted ? (
            <div className="text-center py-6 bg-emerald-50 dark:bg-emerald-900/20 rounded-xl border border-emerald-100 dark:border-emerald-800">
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400 mb-6">
                You have successfully completed your Step-Up plan.
              </p>
              <Button
                onClick={handleJoin}
                variant="outline"
                className="border-emerald-200 text-emerald-700 hover:bg-emerald-100 font-semibold"
              >
            ...
            <>
              <div className="flex flex-col gap-2">
                ...
                {weeksCompleted > 0 && !isTargetMet && (
                  <div className="flex items-center gap-2 p-2 bg-blue-50 text-blue-700 rounded-md text-[10px] border border-blue-100 font-bold">
                    ...
                    <span>
                      Advance Payment: {weeksCompleted} {weeksCompleted === 1 ? "Week" : "Weeks"}{" "}
                      Covered
                    </span>
                  </div>
                )}
              ...
              <div className="p-4 bg-gray-50/50 dark:bg-gray-800/50 rounded-lg border border-gray-100 dark:border-gray-800">
                <div className="flex justify-between items-center mb-2">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs font-bold text-gray-600 dark:text-gray-400 uppercase tracking-wider">
                      {isTargetMet
                        ? "Weekly Status (Goal Met)"
                        : `Week ${weeksCompleted + 1} Progress`}
                    </span>
                  </div>
                  <span className="text-sm font-bold text-purple-600 dark:text-purple-300">
                    {isTargetMet ? formatNaira(fixedAmount) : formatNaira(weekPaidSoFar)} /{" "}
                ...
                {!isTargetMet && weeksCompleted > 0 ? (
                  ...
                  !isTargetMet && (
                    <div className="text-[10px] text-gray-400 text-right font-medium italic">
        ...
        <CardFooter className="flex flex-col gap-3 pt-2">
          <div className="grid grid-cols-2 gap-3 w-full">
            ...
            ) : weekPaidSoFar < fixedAmount || arrears > 0 ? (
              <Button
      ...
      <CardHeader className="pb-4">
        <div className="flex justify-between items-start">
          <div>
            <Badge
              variant="secondary"
              className="mb-2 bg-teal-50 text-teal-700 border-teal-100 hover:bg-teal-100"
            >
              Fixed Growth
            </Badge>
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400 font-medium leading-relaxed mt-1 line-clamp-2">
          Step up your financial game by committing to a high-value fixed weekly amount for rapid
          growth.
        </p>
      </CardHeader>
