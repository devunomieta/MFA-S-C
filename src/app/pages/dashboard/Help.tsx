    ...
    <div className="max-w-6xl mx-auto space-y-8">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-gray-500 dark:text-gray-400 mt-1">
            Get assistance with your account or find the right saving plan.
          </p>
        </div>
      </div>
      ...
      <Tabs defaultValue="support" className="space-y-8">
        <TabsList className="bg-gray-100 dark:bg-gray-800 p-1 rounded-xl w-full sm:w-auto">
          <TabsTrigger
            value="support"
            className="rounded-lg px-8 font-bold data-[state=active]:bg-white dark:data-[state=active]:bg-gray-700 data-[state=active]:text-emerald-600 transition-all"
          >
            Support & Contact
          </TabsTrigger>
          <TabsTrigger
              ...
              <Card className="border-0 shadow-sm bg-emerald-600 text-white overflow-hidden relative">
                ...
                <CardHeader>
                  ...
                  <CardDescription className="text-emerald-50/80">
                    Need help creating or managing a plan manually?
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  <p className="text-sm font-medium leading-relaxed">
                    Our experts can help you set up custom plans, manage member contributions
                    offline, and provide escrow services for your group.
                  </p>
                  <Button
                    variant="outline"
                    className="w-full bg-white/10 border-white/20 text-white hover:bg-white hover:text-emerald-700 font-bold rounded-xl"
                    onClick={() => window.open("https://wa.me/2349074049667", "_blank")}
                  >
                    Speak to an Expert
              ...
              <Card className="border-0 shadow-sm bg-white dark:bg-gray-900">
                ...
                <CardContent className="space-y-3 pb-8">
                  <HelpItem
                    ...
                    description="I can't access my account or need to reset my 2FA."
                  />
                  <HelpItem
                    title="Transaction Issues"
                    description="A deposit isn't reflecting or withdrawal is pending."
                  />
                  <HelpItem
                    title="Plan Rules"
                    description="I need clarification on service charges or penalties."
                  />
                  <HelpItem
                    title="KYC Verification"
                    description="My ID documentation is still pending approval."
                  />
                </CardContent>
              </Card>
            </div>
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        <h4 className="text-xs font-bold text-gray-400 uppercase tracking-widest truncate">
          {title}
        </h4>
        <p className="font-bold text-gray-900 dark:text-white truncate" title={value}>
          {value}
        </p>
