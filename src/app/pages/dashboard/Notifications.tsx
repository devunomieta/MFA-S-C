          ...
          <div className="flex flex-wrap items-center justify-between gap-4">
            <div className="flex items-center gap-2 overflow-x-auto pb-1 scrollbar-none">
              <Button
                ...
                className="rounded-full font-bold h-9 bg-emerald-600"
              >
                All
              </Button>
              <Button
              ...
              <Button
                variant={filter === "plan" ? "default" : "outline"}
                size="sm"
              ...
              <Button
                variant={filter === "help" ? "default" : "outline"}
                size="sm"
            ...
            <div className="flex items-center gap-2">
              {(searchQuery || dateRange.start || filter !== "all") && (
                <Button
                  ...
                  className="h-9 px-3 text-red-500 font-bold hover:bg-red-50 dark:hover:bg-red-900/10 rounded-full text-xs"
                >
                  Clear all
                </Button>
              )}
          ...
          {loading ? (
            <div className="space-y-4">
              {[1, 2, 3, 4].map((i) => (
                <div
                  key={i}
                  className="h-24 rounded-2xl animate-pulse bg-gray-100 dark:bg-gray-800/50"
                />
              ))}
            </div>
          ) : (
        ...
        <TabsContent value="settings">
          <Card className="border-2 dark:border-gray-800 rounded-3xl overflow-hidden">
            <CardHeader className="bg-gray-50/50 dark:bg-gray-800/50 border-b dark:border-gray-800">
              ...
              <CardDescription className="text-gray-500 font-medium font-medium">
              ...
              <div className="grid gap-6">
                <div className="flex items-center justify-between p-6 bg-white dark:bg-gray-800/30 rounded-2xl border-2 border-gray-100 dark:border-gray-800 hover:border-emerald-500/20 transition-all">
                  <div className="space-y-1">
                    ...
                    <p className="text-sm text-gray-500 font-medium">
                      Receive transaction receipts and account alerts via email.
                    </p>
                  </div>
                  <Switch
                ...
                <div className="flex items-center justify-between p-6 bg-white dark:bg-gray-800/30 rounded-2xl border-2 border-gray-100 dark:border-gray-800 hover:border-emerald-500/20 transition-all">
                  <div className="space-y-1">
                    ...
                    <p className="text-sm text-gray-500 font-medium">
                      Get instant alerts while browsing the MTF dashboard.
                    </p>
                  </div>
                  <Switch
                ...
                <div className="flex items-center justify-between p-6 bg-white dark:bg-gray-800/30 rounded-2xl border-2 border-gray-100 dark:border-gray-800 hover:border-emerald-500/20 transition-all">
                  <div className="space-y-1">
                    ...
                    <p className="text-sm text-gray-500 font-medium">
                      Stay updated with new saving plans and exclusive promos.
                    </p>
                  </div>
                  <Switch
    ...
    return (
      <div className="flex flex-col items-center justify-center py-24 bg-white dark:bg-gray-800/30 rounded-[2rem] border-2 border-dashed border-gray-100 dark:border-gray-800">
        ...
        <h3 className="text-2xl font-black text-gray-900 dark:text-white mb-2">
          {emptyStateTitle || "Clean Slate!"}
        </h3>
        <p className="text-gray-500 font-medium text-center max-w-xs">
          {emptyStateMessage || "No notifications match your active search or filters."}
        </p>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-4">
      {notifications.map((n) => (
        ...
        >
          {!n.is_read && (
            <div className="absolute left-0 top-6 bottom-6 w-1.5 bg-emerald-500 rounded-r-full shadow-[0_0_10px_rgba(16,185,129,0.5)]" />
          )}
          ...
          <div className="flex-1 min-w-0">
            <div className="flex justify-between items-start mb-1">
              <div className="flex items-center gap-3">
                <h3
                  className={`text-lg font-bold leading-none ${!n.is_read ? "text-gray-900 dark:text-white" : "text-gray-600 dark:text-gray-400"}`}
                >
                  {n.title}
                </h3>
                {!n.is_read && (
                  <Badge className="h-5 px-1.5 bg-emerald-100 text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-400 border-0 text-[9px] font-black uppercase">
                    Unread
                  </Badge>
                )}
              </div>
            ...
            <p
              className={`text-[15px] font-medium leading-relaxed mb-4 ${!n.is_read ? "text-gray-600 dark:text-gray-300" : "text-gray-500 dark:text-gray-500"}`}
            >
              {n.message}
            </p>
            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              <div
                className={`px-2 py-1 rounded-lg text-[10px] uppercase font-black tracking-widest ${
                  n.type === "plan"
