...
export function MarathonAdminView({ plan }: MarathonAdminViewProps) {
                                        ...
                                        <TableCell>
                                            <div className="flex items-center gap-2">
                                                <div className="w-16 h-2 bg-slate-100 rounded-full overflow-hidden">
                                                    <div className="h-full bg-emerald-500" style={{ width: `${(weeksPaid / duration) * 100}%` }} />
                                                </div>
                                                <span className="text-xs text-slate-600">{weeksPaid}/{duration}</span>
                                            </div>
                                        </TableCell>
