      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
        ...
        <div className="flex gap-2">
          <Button
            variant="outline"
            size="sm"
            className="rounded-xl border-slate-200 bg-white font-semibold text-slate-600 shadow-none h-9"
            onClick={() => fetchStats()}
          >
            Refresh Data
          </Button>
      ...
      <div className="grid lg:grid-cols-3 gap-8 items-start">
        <div className="lg:col-span-2 space-y-8">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <Card
              className="border border-slate-200/60 bg-white shadow-sm rounded-2xl p-6 flex items-center gap-4 group cursor-pointer"
            ...
            <Card
              className="border border-slate-200/60 bg-slate-950 shadow-sm rounded-2xl p-6 flex items-center gap-4 group cursor-pointer"
        ...
        <Card className="border border-slate-200/60 bg-white shadow-sm rounded-2xl overflow-hidden">
              ...
              activity.map((tx) => (
                ...
                >
                  <div className="flex items-center gap-3">
                    <div
                      className={`size-2 rounded-full ${tx.type === "deposit" ? "bg-emerald-500" : tx.type === "withdrawal" ? "bg-red-500" : "bg-blue-500"}`}
                    />
                    <div>
                  ...
                  <div className="text-right">
                    <p
                      className={`text-xs font-bold ${tx.type === "deposit" ? "text-emerald-600" : tx.type === "withdrawal" ? "text-red-600" : "text-slate-900"}`}
                    >
          ...
          <button
            className="w-full p-4 text-[10px] font-black text-slate-400 uppercase tracking-widest bg-slate-50/50 hover:bg-slate-100 transition-colors"
            onClick={() => navigate("/admin/transactions")}
          >
            View Global Stream
          </button>
