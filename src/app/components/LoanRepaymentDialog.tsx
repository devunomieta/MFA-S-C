      ...
      <DialogContent className="sm:max-w-[500px] dark:bg-gray-800 dark:border-gray-700">
        <DialogHeader>
          ...
          <DialogDescription className="dark:text-gray-400">
            ...
            <br />
            <br />
            To ensure platform sustainability, plan withdrawals are restricted while loans are
            active.
          </DialogDescription>
        </DialogHeader>
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="text-left">
                  ...
                  <div className="text-xs opacity-90">
                    Instantly clears loan (₦{loanAmount.toLocaleString()}) and withdraws balance (₦
                    {(withdrawalAmount - loanAmount).toLocaleString()})
                  </div>
                </div>
              </div>
            </Button>
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="text-left">
                  <div className="font-bold">
                    Pay Partial Loan (₦{withdrawalAmount.toLocaleString()})
                  </div>
                  <div className="text-xs opacity-90">Reduces your loan balance.</div>
                </div>
              </div>
            </Button>
          )}
