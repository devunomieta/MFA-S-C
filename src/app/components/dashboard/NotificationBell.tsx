      ...
      >
              ...
              {notifications.slice(0, 10).map((n) => (
                ...
                >
                  ...
                  <div className="flex justify-between items-start gap-2">
                    <p
                      className={`text-[13px] font-bold leading-tight ${!n.is_read ? "text-gray-900 dark:text-white" : "text-gray-550 dark:text-gray-400"}`}
                    >
                      {n.title}
                    </p>
                  ...
                  <div className="flex items-center justify-between mt-0.5">
                    <Badge
                      variant="outline"
                      className="text-[9px] uppercase font-black tracking-widest bg-white dark:bg-gray-900 h-4 border-gray-100 dark:border-gray-800"
                    >
                      {n.type}
                    </Badge>
        ...
        <div className="p-3 border-t dark:border-gray-800 bg-gray-50/50 dark:bg-gray-800/30">
          <Button
            asChild
            variant="default"
            className="w-full h-10 text-xs font-bold bg-emerald-600 hover:bg-emerald-700 rounded-xl"
            onClick={() => setIsOpen(false)}
          >
