...
import { AlertCircle, CheckCircle2, TrendingUp, Wallet, Calendar, AlertTriangle } from "lucide-react";
    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <div className="bg-white dark:bg-gray-950 p-6 rounded-[2rem] border border-gray-100 dark:border-gray-800 shadow-sm relative overflow-hidden group">
                ...
                <p className="text-[10px] font-black uppercase text-gray-400 tracking-wider mb-1">Total Saved</p>
            ...
            <div className="bg-white dark:bg-gray-950 p-6 rounded-[2rem] border border-gray-100 dark:border-gray-800 shadow-sm relative overflow-hidden group">
                ...
                <p className="text-[10px] font-black uppercase text-gray-400 tracking-wider mb-1">Arrears / Missed</p>
                <p className={`text-2xl font-black ${arrears > 0 ? 'text-rose-600' : 'text-gray-900 dark:text-white'}`}>
                    {formatCurrency(arrears)}
                </p>
                <div className="mt-2 flex items-center gap-1.5">
                    <AlertTriangle className={`size-3 ${arrears > 0 ? 'text-rose-500' : 'text-emerald-500'}`} />
                    <span className={`text-[10px] font-bold uppercase ${arrears > 0 ? 'text-rose-500' : 'text-emerald-500'}`}>
            ...
            <div className="bg-white dark:bg-gray-950 p-6 rounded-[2rem] border border-gray-100 dark:border-gray-800 shadow-sm relative overflow-hidden group">
                ...
                <p className="text-[10px] font-black uppercase text-gray-400 tracking-wider mb-1">Daily Target</p>
            ...
            <div className="bg-white dark:bg-gray-950 p-6 rounded-[2rem] border border-gray-100 dark:border-gray-800 shadow-sm relative overflow-hidden group">
                ...
                <p className="text-[10px] font-black uppercase text-gray-400 tracking-wider mb-1">Plan Health</p>
                <div className="flex items-center gap-2">
                    <Badge className={`px-4 py-1 rounded-xl font-black text-[10px] uppercase tracking-wider ${
                ...
                <p className="mt-2 text-[10px] font-medium text-gray-500 leading-tight">
                    {isHealthy ? 'You are doing great! Keep it up.' : 'Please cover your arrears to stay on track.'}
                </p>
            </div>
        </div>
    );
