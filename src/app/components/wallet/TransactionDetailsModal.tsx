      ...
      <DialogContent className="dark:bg-gray-900 dark:border-gray-800 sm:max-w-[600px] max-h-[85vh] overflow-y-auto">
        <DialogHeader>
          <div className="flex items-center gap-3">
            ...
            <div>
              <DialogTitle className="dark:text-white capitalize text-xl">
        ...
        <div className="space-y-6 py-2">
          ...
          {(transaction.type === "loan_repayment" || transaction.type === "loan_disbursement") &&
            relatedData && (
              <div className="space-y-3 border-t border-gray-100 dark:border-gray-700 pt-4">
                ...
                <div className="grid grid-cols-2 gap-2 text-sm">
                  ...
                  <div className="p-3 border rounded dark:border-gray-700">
                    ...
                    <span
                      className={`font-medium capitalize ${relatedData.status === "active" ? "text-green-600" : "text-gray-600"}`}
                    >
                      {relatedData.status}
                    </span>
                  </div>
          ...
          {["deposit", "withdrawal", "transfer"].includes(transaction.type) &&
            transaction.plan_id &&
            relatedData && (
              <div className="space-y-3 border-t border-gray-100 dark:border-gray-700 pt-4">
                <h4 className="text-sm font-semibold dark:text-white flex items-center gap-2">
            ...
            <div className="space-y-3 border-t border-gray-100 dark:border-gray-700 pt-4">
              ...
              <div className="border rounded-md border-gray-100 dark:border-gray-700 max-h-[200px] overflow-y-auto">
                {relatedHistory.map((tx) => (
                  <div
                    key={tx.id}
                    className={`flex justify-between items-center p-2 text-xs border-b last:border-0 border-gray-100 dark:border-gray-800 ${tx.id === transaction.id ? "bg-blue-50 dark:bg-blue-900/10" : ""}`}
                  >
                    <div className="flex flex-col">
